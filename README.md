...
面向跨境电商运营人员的 AI 全栈业务应用。当前已完成融合工程骨架、数据库认证/RBAC、商家商品 SKU 管理、订单与经营看板、AI 会话底座；后续将按”单商品 AI 优化闭环”的顺序推进。
...
当前自动化测试覆盖认证、角色守卫、商家隔离、商品分页隔离、负库存、订单状态机、看板聚合、AI 会话隔离、流式消息持久化和停止生成。生产构建仍有前端主包体积提示，后续阶段将结合路由懒加载处理。
